        ...
        <div v-else class="glass-panel" :class="{ 'opacity-60': pending }">
            ...
            <NuxtLink v-for="w in wars" :key="w.war_id" :to="`/war/${w.war_id}`"
                ...
                <div class="flex items-center gap-2.5 min-w-0">
                    <img :src="entityImage(w.aggressor)" class="w-8 h-8 rounded flex-shrink-0" loading="lazy">
                    <div class="min-w-0">
                ...
                <div class="flex items-center gap-2.5 min-w-0">
                    <img :src="entityImage(w.defender)" class="w-8 h-8 rounded flex-shrink-0" loading="lazy">
                    <div class="min-w-0">
            ...
            <NuxtLink v-for="w in wars" :key="`m-${w.war_id}`" :to="`/war/${w.war_id}`"
                ...
                <div class="flex items-center gap-2">
                    <div class="flex items-center gap-1.5 flex-1 min-w-0">
                        <img :src="entityImage(w.aggressor)" class="w-7 h-7 rounded flex-shrink-0" loading="lazy">
                        <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-1.5 flex-1 min-w-0 justify-end text-right">
                        ...
                        <img :src="entityImage(w.defender)" class="w-7 h-7 rounded flex-shrink-0" loading="lazy">
                    </div>
                </div>
                <!-- Meta row -->
