...
var Crons = []Cron{
	...
	{Name: "market_history_reconcile", Schedule: "6h", RunOnStart: true,
		Description: "Reconcile the rolling 90-day all-region market history from EVE Ref"},
	{Name: "market_orders_update", Schedule: "30m", RunOnStart: true,
		Description: "Replace the current all-region market order book when EVE Ref changes"},
