...
var tagDescriptions = map[string]string{
	...
	"admin-announcements": "Creating, editing, and archiving site announcements.",
	"admin-blog":          "Authoring, previewing, and publishing blog posts.",
	"admin-campaigns":     "Campaign approval, actions, and prize payout marking.",
	"admin-comments":      "Comment moderation: the queue, reports, hiding, and restoring.",
	...
	"domains":             "Assets served for custom-domain killboards.",
	...
	"wallet":              "Campaign prize wallet balances for the signed-in character.",
