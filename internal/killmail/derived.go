...
func Subject(cache *eve.Cache, km Killmail) killtype.Subject {
	s := killtype.Subject{
		...
		IsAwox:            km.IsAwox,
		IsCapitalInvolved: km.IsCapitalInvolved,
		IsSuperInvolved:   km.IsSuperInvolved,
		IsTitanInvolved:   km.IsTitanInvolved,
		IsATShipInvolved:  km.IsATShipInvolved,
		FWWinnerFactionID: km.FWWinnerFactionID,
